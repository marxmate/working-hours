...
import { WhLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: WhLoginModalComponent;
        let fixture: ComponentFixture<WhLoginModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    declarations: [WhLoginModalComponent],
                    providers: [
                        {
                    ...
                    .overrideTemplate(WhLoginModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(WhLoginModalComponent);
