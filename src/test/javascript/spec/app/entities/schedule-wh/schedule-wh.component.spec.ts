...
import { ScheduleWhComponent } from 'app/entities/schedule-wh/schedule-wh.component';
...
describe('Component Tests', () => {
    describe('ScheduleWh Management Component', () => {
        let comp: ScheduleWhComponent;
        let fixture: ComponentFixture<ScheduleWhComponent>;
        let service: ScheduleWhService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [WorkinghoursTestModule],
                declarations: [ScheduleWhComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ScheduleWhComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ScheduleWhComponent);
